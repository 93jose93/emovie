...
class DetailMovieModel {
  ...
  @override
  String toString() {
    return "$adult, $backdropPath, $belongsToCollection, $budget, $genres, $homepage, $id, $imdbId, $originCountry, $originalLanguage, $originalTitle, $overview, $popularity, $posterPath, $productionCompanies, $productionCountries, $releaseDate, $revenue, $runtime, $spokenLanguages, $status, $tagline, $title, $video, $voteAverage, $voteCount";
  }
}
...
class ProductionCompany {
  ...
  @override
  String toString() => "$id, $logoPath, $name, $originCountry";
}
...
class SpokenLanguage {
  ...
  @override
  String toString() => "$englishName, $iso6391, $name";
}
